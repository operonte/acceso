...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final Map<String, UserRole> _roleKeys = {
    ...
    '***REMOVED***': UserRole.guardia,
    '***REMOVED***': UserRole.cliente,
  };
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 8),
                      Text('• Administrador: ***REMOVED***', style: TextStyle(color: slate300, fontSize: 12)),
                      SizedBox(height: 4),
                      Text('• Guardia: ***REMOVED***', style: TextStyle(color: slate300, fontSize: 12)),
                      SizedBox(height: 4),
                      Text('• Cliente: ***REMOVED***', style: TextStyle(color: slate300, fontSize: 12)),
                    ],
                  ),
                ),
              ],
