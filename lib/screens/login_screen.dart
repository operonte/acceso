...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final Map<String, UserRole> _roleKeys = {
    '***REMOVED-SECRET***': UserRole.admin,
    '***REMOVED-SECRET***': UserRole.guardia,
    '***REMOVED-SECRET***': UserRole.cliente,
  };
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 8),
                      Text('• Administrador: ***REMOVED-SECRET***', style: TextStyle(color: slate300, fontSize: 12)),
                      SizedBox(height: 4),
                      Text('• Guardia: ***REMOVED-SECRET***', style: TextStyle(color: slate300, fontSize: 12)),
                      SizedBox(height: 4),
                      Text('• Cliente: ***REMOVED-SECRET***', style: TextStyle(color: slate300, fontSize: 12)),
                    ],
                  ),
                ),
              ],
