...
* **Control de Roles:** Niveles de accesos delimitados por claves fijas locales:
  * `***REMOVED-SECRET***` ➔ **Administrador** (Acceso completo, creación, edición, eliminación y exportación).
  * `***REMOVED-SECRET***` ➔ **Operador Guardia** (Lectura, registro de accesos y escaneo).
  * `***REMOVED-SECRET***` ➔ **Vista Cliente** (Solo lectura y exportación).
